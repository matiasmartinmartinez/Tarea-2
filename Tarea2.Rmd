...
med %>% drop_na() %>% select(Edad_años ,Sexo ) %>% ggplot(aes(Edad_años,fill=Sexo,colour=Sexo)) + geom_density(alpha=0.55,show.legend = F) + labs(x="Edad en Años",y="Frecuencia relativa", title="Diagrama de densidad: distribución de la edad según sexo")
